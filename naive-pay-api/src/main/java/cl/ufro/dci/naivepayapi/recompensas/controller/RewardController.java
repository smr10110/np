...
public class RewardController {
    ...
    public ResponseEntity<List<RewardTransactionDTO>> getUserHistory(@PathVariable Long userId) {
    ...
    public ResponseEntity<RewardAccountDTO> getAccount(@PathVariable Long userId) {
