...
export const navItems: NavItem[] = [
  {
    ...
    subItems: [
      { name: "Inicio", path: "/" },
      {
        ...
        path: "/report",
        icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2"/><path d="M7 17V13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M12 17V9" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M17 17V7" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`
      },
      { name: "Fondos", path: "/fondos"}
    ],
  }
];
...
export const otherItems: NavItem[] = [
  {
    ...
    name: "Autenticación",
    subItems: [
      { name: "Iniciar sesión", path: "/auth/login", pro: false },
      { name: "Registrarse", path: "/auth/register", pro: false },
    ],
  },{

    icon:`<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <!-- Fachada -->
  <path d="M3 9H21V21H3V9Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"/>
  <!-- Techo -->
  <path d="M4 9L12 3L20 9" stroke="currentColor" stroke-width="2" stroke-linejoin="round" stroke-linecap="butt"/>
  <!-- Puerta -->
  <path d="M7 21V14H17V21" stroke="currentColor" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"/>
</svg>`,
    name: "Comercio",
        subItems: [
            {name: "Ingresar Comercio", path: "/registercommerce", pro:false},
            {name: "Validar Comercios", path: "/validatecommerce", pro:false},
            {name: "Ver Comercios", path: "/commerces", pro:false}
        ]
    }
];